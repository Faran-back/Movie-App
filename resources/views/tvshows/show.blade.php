        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-lg sm:rounded-lg">
                ...
                <div class="relative w-full h-[500px]">
                    ...
                    <img src="https://image.tmdb.org/t/p/original{{ $tv_shows['backdrop_path'] }}"
                         alt="{{ $tv_shows['name'] }}"
                    ...
                    <div class="absolute bottom-8 left-8 text-white z-10">
                        <h1 class="text-4xl font-extrabold drop-shadow-lg">{{ $tv_shows['name'] }}</h1>
                        <div class="flex items-center mt-2">
                            <p class="text-lg bg-yellow-500 text-black px-3 py-1 rounded-full">⭐ {{ $tv_shows['vote_average'] }}/10</p>
                            <p class="ml-4 text-lg">{{ \Carbon\Carbon::parse($tv_shows['last_air_date'])->format('F d, Y') }} ?? {{ "Not Published Yet" }}</p>
                        </div>
                    </div>
                </div>
